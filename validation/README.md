...
- `coder3_annotations.csv` contains eight operational exclusions applied during Nov-Dec 2025 batch pipeline review (non-overlapping with the five finalized exclusion cases). These records document exclusions made during running and cross-checking; they do not modify the finalized five-case exclusion register or the published N = 586 count.
